...
<!-- saved from url=(0057)http://www.ecs.csus.edu/webApps/useraccount_app/index.cgi -->
<html>
	<head>
		<meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1">
		<title>ECS Computing Services Request for Computer User Account / Action –– Request MySQL Database</title>
	...
	<body onload="frmFocus();">
		<table width="590" border="0" align="center">
			<tbody>
				...
				<tr>
					<td id="formHeading"><strong>Request MySQL Database</strong></td>
				</tr>
				<tr>
					<td height="10">
						<img alt="Spacer Image" src="./javascripts/spacer.gif" width="1" height="1">
				...
				<tr>
					<td>
						<form name="mysqlRequestForm2" method="post" onsubmit="return validateMySQLRequest2( document.mysqlRequestForm2 )" action="submitSQL.php"> 
							<!-- HTML HIDDEN FIELDS GO HERE -->
							<input type="hidden" name="form_id" value="mysql_database_request2">
							...
							<input type="hidden" name="mysql_host_location" value="<?php echo $_POST["mysql_host_location"]; ?>">
							...
							<!--the following php finds out which MySQL permissions were selected and stores the selected ones with a 'y' value-->
							<?php
								if (in_array("ALTER", $_POST['mysql_permissions'])) { 
									echo '<input type="hidden" name="alter" value="y">'; 
								} else{ 
									echo '<input type="hidden" name="alter" value="n">'; 
								}
								if (in_array("DELETE", $_POST['mysql_permissions'])) { 
									echo '<input type="hidden" name="delete" value="y">'; 
								}else{ 
									echo '<input type="hidden" name="delete" value="n">'; 
								}
								if (in_array("INDEX", $_POST['mysql_permissions'])){ 
									echo '<input type="hidden" name="index" value="y">'; 
								}else{ 
									echo '<input type="hidden" name="index" value="n">'; 
								}
								if (in_array("INSERT", $_POST['mysql_permissions'])){ 
									echo '<input type="hidden" name="insert" value="y">'; 
								}else{ 
									echo '<input type="hidden" name="insert" value="n">'; 
								}
								if (in_array("SELECT", $_POST['mysql_permissions'])){ 
									echo '<input type="hidden" name="select" value="y">'; 
								}else{ 
									echo '<input type="hidden" name="select" value="n">'; 
								}
								if (in_array("UPDATE", $_POST['mysql_permissions'])){ 
									echo '<input type="hidden" name="update" value="y">'; 
								}else{ 
									echo '<input type="hidden" name="update" value="n">'; 
								}
								if (in_array("CREATE", $_POST['mysql_permissions'])){ 
									echo '<input type="hidden" name="create" value="y">'; 
								}else{ 
									echo '<input type="hidden" name="create" value="n">'; 
								}
								if (in_array("DROP", $_POST['mysql_permissions'])){ 
									echo '<input type="hidden" name="drop" value="y">'; 
								}else{ 
									echo '<input type="hidden" name="drop" value="n">'; 
								}
								if (in_array("REFERENCES", $_POST['mysql_permissions'])){ 
									echo '<input type="hidden" name="ref" value="y">'; 
								}else{ 
									echo '<input type="hidden" name="ref" value="n">'; 
								}
							?>	
										...
										<td width="565">
											<table width="100%" border="0">
												...
												<!--posted data from previous form for display and reposting-->
													<tr>
														<td colspan="2" class="content">Database name: <?php echo $_POST["database_name"]; ?>
															<input type="hidden" name="database_name" value="<?php echo $_POST["database_name"]; ?>">
														</td>
													</tr>	
													<tr>
													...
													<tr>
														<td colspan="2" class="content">Number of semesters account is active for: <?php echo $_POST["num_semesters"]; ?>
															<input type="hidden" name="num_semesters" value="<?php echo $_POST["num_semesters"]; ?>">
														</td>
													</tr>	
													<tr>
														<td colspan="2" class="content">MySQL host location: <?php echo $_POST["mysql_host_location"]; ?>
															<input type="hidden" name="mysql_host_location" value="<?php echo $_POST["mysql_host_location"]; ?>">
														</td>
													</tr>	
													<tr>
														<td colspan="2" class="content">MySQL permissions: <?php echo $_POST["permissions_radio"]; ?>
															<input type="hidden" name="permissions_radio" value="<?php echo $_POST["permissions_radio"]; ?>">
														</td>
													</tr>	
													<tr>
													...
													<?php 
														for($tr=1;$tr<=$_POST["num_students"];$tr++){ 
															...
															echo '<tr>
																	<td colspan="2">
																		<img alt="Black Background" src="./javascripts/black.gif" height="1" width="350">
																	</td>
																</tr>'; 
															...
															echo '<tr>
																	<td class="fieldLabel" valign="middle" nowrap="">First Name</td>
																		<td class="formField" valign="middle">
																			<input name="fname'.$tr.'" type="text" size="20" maxlength="40">
																		</td>
																	</tr>';	
															echo '<tr>
																	<td colspan="2" height="10">
															...
															echo '<tr>
																	<td class="fieldLabel" valign="middle" nowrap="">Last Name:</td>
																		<td class="formField" valign="middle">
																			<input name="lname'.$tr.'" type="text" size="20" maxlength="40">
																		</td>
																	</tr>';
															echo '<tr>	
																	<td colspan="2" height="10">
															...
															echo '<tr>
																	<td class="fieldLabel" valign="middle" nowrap="">Phone (w/ area code):</td><td class="formField" valign="middle">
																		<input name="phone'.$tr.'" type="text" size="12" maxlength="15">
																	</td>
																</tr>';
															echo '<tr>
																	<td colspan="2" height="10">
															...
															echo '<tr>
																	<td class="fieldLabel" valign="middle" nowrap="">Email Address:</td>
																		<td class="formField" valign="middle">
																			<input name="email'.$tr.'" type="text" size="20" maxlength="45">&nbsp;<span id="fieldRequirements">(Must be a valid email)</span>
																		</td>
																	</tr>';
				...
				<tr>
					<td align="center" id="appFooter">
						<a href="./javascripts/MySQLacct2.htm">main menu</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="http://www.ecs.csus.edu/index.php?content=info">computing services</a>&nbsp;&nbsp;|&nbsp;&nbsp;
