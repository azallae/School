	...
	<body onload="frmFocus();">
		<table width="590" border="0" align="center">
			<tbody>
				...
				<tr>
					<td>
						<form name="studentProjectAccountForm2" method="post" onsubmit="return validateStudentProjectAccountForm2(document.studentProjectAccountForm2);" action="submitDual.php"> 
										...
										<td width="565">
											<table width="100%" border="0">
												<tbody>
													...
													<tr>
														<td colspan="2" class="content">Account/Database name: <?php echo $_POST["account_name"]; ?>
															<input type="hidden" name="account_name" value="<?php $_POST["account_name"]; ?>">
														</td>
													</tr>	
													<tr>
														<td colspan="2" class="content">Disk quota: 
															<?php echo $_POST["disk_quota"]; ?> MB 
															<input type="hidden" name="disk_quota" value="<?php echo $_POST["disk_quota"]; ?>">
														</td>
													</tr>	
													<tr>
														<td colspan="2" class="content">Project advisor: 
															<?php echo $_POST["project_advisor"]; ?>
															<input type="hidden" name="project_advisor" value="<?php echo $_POST["project_advisor"]; ?>">
														</td>
													</tr>	
													<tr>
														<td colspan="2" class="content">Advisor email: 
															<?php echo $_POST["advisor_email"]; ?>
															<input type="hidden" name="advisor_email" value="<?php echo $_POST["advisor_email"]; ?>">
														</td>
													</tr>	
													<tr>
														<td colspan="2" class="content">Unix Shell: 
															<?php echo $_POST["shell"]; ?>
															<input type="hidden" name="shell" value="<?php echo $_POST["shell"]; ?>">
														</td>
													</tr>	
													<tr>
													...
													<tr>
														<td colspan="2" class="content">Database Name: <?php echo $_POST["account_name"]; ?>
															<input type="hidden" name="account_name" value="<?php echo $_POST["account_name"]; ?>">
														</td>
													</tr>
													<tr>
													...
													<tr>
														<td colspan="2" class="content">MySQL Permissions: <?php echo $_POST["permissions_radio"]; ?></td>
															<input type="hidden" name="permissions_radio" value="<?php echo $_POST["permissions_radio"]; ?>"></td></tr>	
													</tr>
													<tr>
													...
													<?php 
														for($tr=1;$tr<=$_POST["num_students"];$tr++){ 
															...
															echo '<tr>
																	<td class="fieldLabel" valign="middle" nowrap="">Phone (w/ area code):</td>
																	<td class="formField" valign="middle">
															...
															echo '<tr>
																	...
																	<td class="formField" valign="middle">
																		<input name="email'.$tr.'" type="text" size="20" maxlength="45">&nbsp;
																		<span id="fieldRequirements">(Must be a valid email)</span>
																	</td>
																</tr>';
				...
				<tr>
					<td align="center" id="appFooter"><a href="./javascripts/DualForm2.htm">main menu</a>&nbsp;&nbsp;|&nbsp;&nbsp;
