...
public class Camera3Pcontroller {
	...
	public Camera3Pcontroller(ICamera cam, SceneNode target, IInputManager inputMgr, String controllerName) { 
		...
		cameraDistanceFromTarget = 20.0f; 
	...
	private void setupInput(IInputManager im, String cn) { 
		...
		im.associateAction(cn, net.java.games.input.Component.Identifier.Axis.RX, turnLR, IInputManager.INPUT_ACTION_TYPE.REPEAT_WHILE_DOWN); 
		IAction orbitActionLeft = new OrbitAroundActionLeft();
		im.associateAction(cn, net.java.games.input.Component.Identifier.Key.LEFT, orbitActionLeft, IInputManager.INPUT_ACTION_TYPE.REPEAT_WHILE_DOWN);
		im.associateAction(cn, net.java.games.input.Component.Identifier.Button._4, orbitActionLeft, IInputManager.INPUT_ACTION_TYPE.REPEAT_WHILE_DOWN);
		IAction orbitActionRight = new OrbitAroundActionRight();
		im.associateAction(cn, net.java.games.input.Component.Identifier.Key.RIGHT, orbitActionRight, IInputManager.INPUT_ACTION_TYPE.REPEAT_WHILE_DOWN);
		im.associateAction(cn, net.java.games.input.Component.Identifier.Button._5, orbitActionRight, IInputManager.INPUT_ACTION_TYPE.REPEAT_WHILE_DOWN); 
		IAction zoomIn = new ZoomIn();
		im.associateAction(cn, net.java.games.input.Component.Identifier.Key.UP, zoomIn, IInputManager.INPUT_ACTION_TYPE.REPEAT_WHILE_DOWN);
		IAction zoomOut = new ZoomOut();
		im.associateAction(cn, net.java.games.input.Component.Identifier.Key.DOWN, zoomOut, IInputManager.INPUT_ACTION_TYPE.REPEAT_WHILE_DOWN);
		IAction zoomIO = new ZoomIO();
		im.associateAction(cn, net.java.games.input.Component.Identifier.Axis.RY, zoomIO, IInputManager.INPUT_ACTION_TYPE.REPEAT_WHILE_DOWN);
		IAction toggleDetached = new ToggleDetached();
		im.associateAction(cn, net.java.games.input.Component.Identifier.Key.CAPITAL, toggleDetached, IInputManager.INPUT_ACTION_TYPE.ON_PRESS_ONLY);
		im.associateAction(cn, net.java.games.input.Component.Identifier.Button._9, toggleDetached, IInputManager.INPUT_ACTION_TYPE.ON_PRESS_ONLY);
	} 
